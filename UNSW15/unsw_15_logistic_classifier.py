...
UNSW_15_DIRECTORY = r'../../datasets/unsw-nb15/UNSW-NB15 - CSV Files/'
UNSW_15_MONDAY_FILENAME = 'Monday-WorkingHours.pcap_ISCX.csv'
UNSW_15_WEDNESDAY_FILENAME = 'Wednesday-workingHours.pcap_ISCX.csv'
UNSW_15_MONDAY = UNSW_15_DIRECTORY + UNSW_15_MONDAY_FILENAME
UNSW_15_WEDNESDAY = UNSW_15_DIRECTORY + UNSW_15_WEDNESDAY_FILENAME

# /machineLearning/datasets/unsw-nb15/UNSW-NB15 - CSV Files/

###############################################################################
## Load dataset
###############################################################################
df = pd.read_csv (UNSW_15_WEDNESDAY)
