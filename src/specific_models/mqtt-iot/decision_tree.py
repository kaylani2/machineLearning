...
###############################################################################
## Analyse mqtt-iot's dataset for intrusion detection using decision_tree
###############################################################################
...
parameters = {'criterion' : ['gini', 'entropy'],
     ...
     #        'max_depth' : [1, 10, 100, 1000, 10000, 100000, 1000000, None], # Something is wrong over here 
...
clf = tree.DecisionTreeClassifier(criterion= 'gini', min_samples_split= 2, splitter= 'random')
